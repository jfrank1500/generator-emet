...
module.exports = yeoman.Base.extend({
    ...
    writing: function () {
        ...
        this._t('_form.controller.js', path + '.controller.js', model);
        this._t('_form.html', path + '.html', model);
        this._t('_form.route.js', path + '.route.js', model);
    },
    _yosay: function () {
        this.option('welcome', {type: Boolean, default: true});
        if (this.options.welcome) {
            this.log(yosay(
                    'Welcome to ' + chalk.red('Emet') + ':form subgenerator!'
                    ));
        }
    },
